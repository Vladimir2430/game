...
function create_level_8() {
  ...
  ledge.body.immovable = true;
  ledge = platforms.create(290, heigth_screen-260, 'platform');
  ledge.body.immovable = true;
...
function create_level_9() {
  ...
  ledge.body.immovable = true;
  ledge = platforms.create(920, heigth_screen-200, 'platform');
  ledge.body.immovable = true;
  ledge = platforms.create(720, heigth_screen-300, 'platform');
  ledge.body.immovable = true;
  ledge = platforms.create(620, heigth_screen-400, 'platform');
  ledge.body.immovable = true;
  ledge = platforms.create(420, heigth_screen-300, 'platform');
  ledge.body.immovable = true;
  ledge = platforms.create(190, heigth_screen-200, 'platform');
  ledge.body.immovable = true;
...
function create_level_10() {
  ...
  ledge.body.immovable = true;
  ledge = platforms.create(40, heigth_screen-300, 'platform');
  ledge.body.immovable = true;
  ...
  ledge.body.immovable = true;
  ledge = platforms.create(640, heigth_screen-280, 'platform');
  ledge.body.immovable = true;
	ledge = platforms.create(890, heigth_screen-200, 'platform');
  ledge.body.immovable = true;
